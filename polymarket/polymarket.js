...
(function () {
  ...
  function refresh() {
    ...
    return Promise.all(midCalls.concat(quoteCalls)).then(function () {
      ...
      setPills(false);
      $('#last-updated').textContent = 'Snapshot · Jul 27, 2026 15:00 UTC (live APIs unreachable)';
      var st = $('#sync-time'); if (st) st.textContent = 'Jul 27, 2026 15:00 UTC (baked snapshot — live APIs unreachable)';
    });
  }
